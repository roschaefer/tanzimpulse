...
<section>
  <div class="container">
    <div class="grid grid-cols-2 gap-10">
      <DefaultCard>
        <h2 class="text-3xl uppercase font-bold text-ti_blue_accent tracking-wide">Impressum</h2>
        <h2 class="text-3xl uppercase font-extralight text-ti_blue_mat tracking-wide mb-4">TANZIMPULSE – Institut für Tanzpädagogik</h2>
        ...
        <p class="py-2">
          Zu den <a class="font-bold pt-2 uppercase text-xs tracking-wider hover:text-ti_blue_accent ease-in-out transition-all duration-300" href="https://www.bildungsurlaub.de/bildungsurlaub_nrw.html" rel="noreferrer" target="_blank">Fördermöglichkeiten</a>.
        </p>
        <p class="py-2">© TANZIMPULSE 2002-2021</p>
        <hr class="block border border-coolGray-100 w-full mt-4 mb-8" />
        <h2 class="text-3xl uppercase font-extralight text-ti_blue_mat tracking-wide mb-4">Haftungsausschluss</h2>
