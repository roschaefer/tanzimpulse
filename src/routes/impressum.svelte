  ...
  <div class="container">
    <div class="grid grid-cols-1 gap-10">
      <DefaultCard>
        ...
        <p class="py-2">Diese Webseite wurde mit größtmöglicher Sorgfalt zusammengestellt. Wir bemühen uns alle Angaben stets auf dem aktuellen Stand zu halten. Eine Haftung oder Garantie für die Richtigkeit und Vollständigkeit der zur Verfügung gestellten Informationen und Daten kann aber nicht gegeben werden. WebDesign-Impulse schließt jegliche Haftung für Schäden, die direkt oder indirekt aus der Benutzung dieser Website entstehen, aus.</p>
        <p class="py-2">Gemäß dem Urteil vom 12. Mai 1998 "Haftung für Links" (312 O 85/98) des Landgerichts Hamburg distanziert sich WebDesign-Impulse ausdrücklich von allen Inhalten sämtlicher gelinkter Seiten. Für den Inhalt der verlinkten Seiten sind ausschließlich deren Betreiber verantwortlich.</p>
        <hr class="block border border-coolGray-100 w-full mt-4 mb-8" />
