      ...
      <DefaultCard>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div class="flex flex-col py-4">
            ...
            <div class="pt-4">
              <h2 class="text-3xl uppercase font-bold text-ti_blue_accent tracking-wide text-center mb-4">Bettina Bierdümpel</h2>
          ...
          <div class="flex flex-col py-4">
            ...
            <div class="pt-4">
              <h2 class="text-3xl uppercase font-bold text-ti_blue_accent tracking-wide text-center mb-4">Ute Luckey</h2>
      ...
      <DefaultCard>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div class="___single_employee flex flex-col py-4">
            ...
            <div class="pt-4">
              <h2 class="text-3xl uppercase text-ti_blue_mat tracking-wide text-center mb-4">Nicole Stefan-Schick</h2>
          ...
          <div class="___single_employee flex flex-col py-4">
            ...
            <div class="pt-4">
              <h2 class="text-3xl uppercase text-ti_blue_mat tracking-wide text-center mb-4">Suna Göncü</h2>
          ...
          <div class="___single_employee flex flex-col py-4">
            ...
            <div class="pt-4">
              <h2 class="text-3xl uppercase text-ti_blue_mat tracking-wide text-center mb-4">Astrid Cacutalua-Tujek</h2>
          ...
          <div class="___single_employee flex flex-col py-4">
            ...
            <div class="pt-4">
              <h2 class="text-3xl uppercase text-ti_blue_mat tracking-wide text-center mb-4">Renate Kampmann</h2>
          ...
          <div class="___single_employee flex flex-col py-4">
            ...
            <div class="pt-4">
              <h2 class="text-3xl uppercase text-ti_blue_mat tracking-wide text-center mb-4">Susanne Peters</h2>
          ...
          <div class="___single_employee flex flex-col py-4">
            ...
            <div class="pt-4">
              <h2 class="text-3xl uppercase text-ti_blue_mat tracking-wide text-center mb-4">Uta Wolff</h2>
